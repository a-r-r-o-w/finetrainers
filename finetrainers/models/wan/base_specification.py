...
class WanModelSpecification(ModelSpecification):
    def __init__(
        ...
        **kwargs,
        ...
        use_last_frame = getattr(self.transformer_config, "pos_embed_seq_len", None) is not None
        ...
        if getattr(self.transformer_config, "image_dim", None) is not None:
    ...
    def load_pipeline(
        ...
        **kwargs,
        ...
        if getattr(self.transformer_config, "image_dim", None) is None:
    ...
    def validation(
        ...
        **kwargs,
        ...
        if getattr(self.transformer_config, "pos_embed_seq_len", None) is not None:
    ...
    def _save_lora_weights(
        ...
        **kwargs,
        ...
        pipeline_cls = (
            WanImageToVideoPipeline if getattr(self.transformer_config, "image_dim", None) is not None else WanPipeline
        )
