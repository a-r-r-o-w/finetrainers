...
from .ltx_video import LTX_VIDEO_T2V_FULL_FINETUNE_CONFIG,LTX_VIDEO_COND_T2V_FULL_FINETUNE_CONFIG, LTX_VIDEO_T2V_LORA_CONFIG
...
SUPPORTED_MODEL_CONFIGS = {
    ...
    "ltx_video": {
        ...
        "full-finetune":LTX_VIDEO_COND_T2V_FULL_FINETUNE_CONFIG # LTX_VIDEO_T2V_FULL_FINETUNE_CONFIG,
    },
    "cogvideox": {
