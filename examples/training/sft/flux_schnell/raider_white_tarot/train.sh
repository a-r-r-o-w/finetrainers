...
TRAINING_DATASET_CONFIG="examples/training/sft/flux_schnell/raider_white_tarot/training.json"
VALIDATION_DATASET_FILE="examples/training/sft/flux_schnell/raider_white_tarot/validation.json"
